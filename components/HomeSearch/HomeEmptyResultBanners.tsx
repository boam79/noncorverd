...
export function HomeEmptyResultBanners({
  ...
  return (
    <>
      {orphanSigungu && (
        <div
          className="mb-4 rounded-xl border border-warning-200 bg-warning-50 px-4 py-3 text-sm text-warning-950"
          role="status"
        >
          <p className="font-medium">선택한 시군구 코드가 목록에 없어요.</p>
          <p className="mt-1 text-warning-900/90">
          ...
          {onClearSigungu && (
            <button
              ...
              className="mt-3 text-sm font-semibold text-warning-950 underline decoration-warning-600"
            >
              시군구 선택 지우기
            </button>
          )}
      ...
      {noApiHospitalRows && (
        <div
          className="mb-4 rounded-xl border border-brand-200 bg-brand-50 px-4 py-3 text-sm text-brand-950"
          role="status"
        >
      ...
      {clinicalFocusExcludedAll && (
        <div
          className="mb-4 rounded-xl border border-warning-200 bg-warning-50 px-4 py-3 text-sm text-warning-900"
          role="status"
        >
          ...
          <button
            ...
            className="mt-3 text-sm font-semibold text-warning-950 underline decoration-warning-600 hover:text-warning-700"
          >
            관심 분야 접기
          </button>
        </div>
